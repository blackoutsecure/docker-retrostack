...
This policy covers the Docker packaging, CI/CD pipelines, and the scripts in `root/usr/local/bin/` (`esde-emulator-run`, `esde-emulator-launch`, `esde-provision`) in this repository. Vulnerabilities in upstream emulators (RetroArch, PPSSPP, Dolphin) should be reported to their respective projects.
